      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                Text(title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black)),
                const SizedBox(height: 7),
                Text(message, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black)),
